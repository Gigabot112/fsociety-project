...
async def show_vip_payment(
    ...
    # ГЛАВНОЕ ИСПРАВЛЕНИЕ
    # =====================================================
    # Теперь заявка создаётся ДО того,
    # как пользователь нажмёт
    # "Я подтвердил оплату".
...
async def user_payment_confirmed(
    ...
    if report["status"] == "waiting_admin_payment_confirmation":
